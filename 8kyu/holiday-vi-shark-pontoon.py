...
# Details
    ...
    the pontoon has a huge slide that drops you out right into the ocean, a small way from a set of stairs used
    to climb out. As you plunge out of the slide into the water, you see a shark hovering in the darkness
    ...
    ... as you do the mental calculations in the water you either freeze when you realise you are dead,
    ...
    You are given 5 variables;
        ...
        dolphin = a boolean, if true, u can half the swimming speed of the shark as the dolphin will
        attack it.
...
def shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin):
    ...
    return "Alive!" if (pontoonDistance / youSpeed) < sharkDistance / (sharkSpeed - (sharkSpeed * 0.5 *
    dolphin)) else "Shark Bait!"
'''
