...
# Details
    ...
    not, so that's the first non-consecutive number. If the whole array is consecutive then return null2.
    ...
    - Can you write a solution that will return null2 for both [] and [ x ] though? (This is an empty
